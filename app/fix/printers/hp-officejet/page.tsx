...
export const metadata: Metadata = {
  title: 'HP OfficeJet Troubleshooting Guides | MyTech-Fix',
  description:
    'Step-by-step fixes for the most common HP OfficeJet problems: offline errors, print queue stuck, WiFi connection issues, and printer not printing.',
  alternates: {
    canonical: `${BASE}/fix/printers/hp-officejet`,
  },
};
...
const HP_OFFICEJET_GUIDES = [
  {
    slug: 'offline',
    title: 'HP OfficeJet Showing Offline in Windows? Fix It Fast',
    description:
  ...
  {
    slug: 'wont-print',
    title: "HP OfficeJet Says Ready But Won't Print? Try This",
    description:
  ...
  },
  {
    ...
    title: "HP OfficeJet Won't Connect to WiFi? Here's the Fix",
    description:
  ...
  },
  {
    ...
    title: 'HP OfficeJet Print Queue Stuck? How to Clear It',
    description:
...
export default function HpOfficejetHubPage() {
  return (
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <header className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-sm font-medium text-slate-400">HP OfficeJet</span>
          </div>
          <h1 className="font-sora text-3xl sm:text-4xl font-bold text-slate-50 tracking-tight mb-3 leading-tight">
            HP OfficeJet Troubleshooting Guides
          </h1>
          <p className="text-slate-400 text-lg leading-relaxed">
            Step-by-step fixes for the most common HP OfficeJet problems. Each guide covers the
            likeliest causes, walks you through the fix, and has an AI chat link if you get stuck.
          </p>
        </header>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-sora text-lg font-semibold text-slate-200">
              All guides — {HP_OFFICEJET_GUIDES.length} fixes
            </h2>
          </div>
          <div className="space-y-3">
            {HP_OFFICEJET_GUIDES.map((guide) => (
              <Link
                key={guide.slug}
                href={`/fix/printers/hp-officejet/${guide.slug}`}
        ...
        <div className="mt-12 rounded-2xl border border-blue-500/20 bg-blue-500/5 px-6 py-6 text-center">
          ...
          <p className="text-slate-400 mb-4 leading-relaxed">
            Describe your HP OfficeJet issue to our AI — it can diagnose error codes, walk through
            driver reinstalls, and troubleshoot models not covered by these guides.
          </p>
          <Link
            href="/chat?device=hp-officejet"
